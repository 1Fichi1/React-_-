...
const Home = () => {
  ...
  return (
    <div className="container mt-5">
      ...
      >
        Welcome to Funko Shop
      </motion.h1>
      <p className="shop-info">
        Funko Shop is your go-to destination for all things Funko! We offer a wide range of Funko Pop figures, exclusive collections, and more. Explore our catalog to find your favorite characters and add them to your collection today!
      </p>
